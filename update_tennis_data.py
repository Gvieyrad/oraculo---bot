...
def _refresh_wta(cache_dir=CACHE_DIR):
    ...
    2026-07-13: ported from oraculo_v2 -- JeffSackmann/tennis_wta (and
    tennis_atp) disappeared from GitHub entirely (confirmed via GitHub API:
    account now has only 1 public repo). Frozen since 2026-04-21. Switched
    to tennis-data.co.uk, same site ATP already uses via td_*.xlsx in this
    file -- {year}w/{year}.xlsx is the WTA equivalent, same column layout.
    """
